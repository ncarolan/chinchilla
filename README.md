...
Everything you need is contained in a single Google Colab notebook and runs on a single (free-tier) NVIDIA T4 GPU. To achieve this, we use small models (<10M parameters) and train on synthetic addition data. 
